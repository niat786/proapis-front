const Footer = () => {
  ...
  return (
    ...
    <footer className=" border border-gray-300  dark:border-[--ui-dark-border-color]">
    <div className="max-w-6xl mx-auto space-y-16 px-6 py-16 text-gray-600 2xl:px-0">
        <div
            className="flex flex-wrap items-center justify-between gap-4 border-b pb-8 border-gray-300  dark:border-[--ui-dark-border-color]">
        ...
        <div className="text-sm rounded-xl shadow-sm p-5 bg-gray-100 px-6 py-3 dark:bg-gray-900">
