const Footer = () => {
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto space-y-16 px-6 py-16 text-gray-600 2xl:px-0">
        <div
            className="flex flex-wrap items-center justify-between gap-4 border-b pb-8 border-[--ui-light-border-color] dark:border-[--ui-dark-border-color]">
        ...
        <div className="text-sm rounded-md p-5 bg-gray-100 px-6 py-3 dark:bg-gray-900">
